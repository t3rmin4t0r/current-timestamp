...
@Description(name = "current_timestamp", value = "_FUNC_() - Returns the current timestamp at the start of query evaluation."
    + " All calls of current_timestamp within the same query return the same value.")
public class CurrentTimeStampUDF extends GenericUDF {
  ...
  public ObjectInspector initialize(ObjectInspector[] arguments)
    ...
    if (currentTimestamp == null) {
      ...
      currentTimestamp = new TimestampWritable(new java.sql.Timestamp(
          now.getTime()));
    }
  ...
  public void copyToNewInstance(Object newInstance) throws UDFArgumentException {
    ...
    CurrentTimeStampUDF other = (CurrentTimeStampUDF) newInstance;
